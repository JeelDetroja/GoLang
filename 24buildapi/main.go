...
func main() {
	fmt.Println("API of Courses")
	r := mux.NewRouter()

	//seeding
	courses = append(courses, Course{CourseId: "2", CourseName: "ReactJS", CoursePrice: 300, Author: &Author{Fullname: "Jeel Detroja", Website: "jeel.com"}})
	courses = append(courses, Course{CourseId: "4", CourseName: "C#", CoursePrice: 400, Author: &Author{Fullname: "Vivek D", Website: "vivek.com"}})
